      ...
      return (
        <div style={styles.lefthalf}>
          <div style={styles.field}>
              <label style={{fontWeight:'bold',marginRight:'5px'}}>Main hall</label>
          </div>
          ...
          <div style={styles.usersContainer}>
            <button style={styles.Tourist}>User1 - Tourist</button>
            <button style={styles.Tourguide}>User2 - Tour guide</button>
            <button style={styles.Tourist}>User3 - Tourist</button>
            <button style={styles.Tourist}>User4 - Tourist</button>
            <button style={styles.Tourist}>User5 - Tourist</button>
            <button style={styles.Tourguide}>User6 - Tour guide</button>
            <button style={styles.Tourguide}>User7 - Tour guide</button>
            <button style={styles.Tourist}>User8 - Tourist</button>
            <button style={styles.Tourist}>User9 - Tourist</button>
            <button style={styles.Tourguide}>User10 - Tour guide</button>
          </div>
        </div>
      );
    };
  ...
  return (
    <div style={styles.container}>
      <div style={styles.topbar}>
        ...
        <label style={styles.pagename}>Grand Egyptian Museum</label>
